...
class SemiAsyncPM3(object):
    ...
    def runServer(self, Server):
        ...
        minimum_picked_client=int(Server.num_clients*Server.selection_ratio) # 한 라운드 동안 수신할 local model 최대 개수
        ...
        while True:
            ...
            picked_client_idx = Server.wait_until_can_update_global_model(minimum_picked_client)
