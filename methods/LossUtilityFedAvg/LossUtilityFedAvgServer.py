...
class LossUtilityFedAvgServer:
    ...
    def receive_local_model_from_selected_clients(self, selected_client_idx):
        for idx in selected_client_idx:
            ...
            self.local_utility[req.source_rank()] = local_model_info[-1]
    ...
    def calculate_coefficient(self, selected_client_idx):
        ...
        data_sum=0
        for idx in selected_client_idx:
            data_sum+=self.len_local_dataset[idx]
        
        for idx in selected_client_idx:
            data_coefficient[idx]=self.len_local_dataset[idx]/data_sum
